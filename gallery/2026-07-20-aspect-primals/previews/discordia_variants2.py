...
Run from repo root:
  python3 gallery/2026-07-20-aspect-primals/previews/discordia_variants2.py
"""
import pathlib, sys
...
CODE = "#4A3459"
OPTS = [("chaosstar", "Chaos star", "radiating arrows"),
        ("vortex",    "Vortex",     "turbulent whirl"),
        ("butterfly", "Attractor",  "Lorenz butterfly"),
        ("hourglass", "Hourglass",  "entropy / time")]
...
def sheet():
    ...
    d.text((x0,26),"Discordia — round 2 (researched chaos/entropy idioms)",font=FT,fill=INK)
    ...
    im.save(PREV/"discordia-options2.png"); print("wrote",PREV/"discordia-options2.png",im.size)
